...
import { Menu, Phone, User, LogIn, Gavel } from 'lucide-react';
    ...
    <header className="sticky top-0 z-50 w-full bg-white border-b border-slate-200 shadow-sm">
      ...
      <div className="bg-slate-900 text-slate-300 text-xs py-2 px-4 sm:px-6 lg:px-8 flex justify-between items-center">
        <div className="flex items-center gap-4">
          <a href="tel:+12604936182" className="flex items-center gap-2 hover:text-white transition-colors font-medium">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-20">
          ...
          <div className="hidden md:flex items-center space-x-6">
            ...
            <Link to="/register" className="bg-red-600 hover:bg-red-700 text-white px-6 py-3 rounded font-black text-sm uppercase tracking-widest transition-colors shadow-md hover:shadow-lg">
              Register to Bid
            </Link>
          </div>
